...
--[[	
	...
	InFieldOfView(pos: float[3]): bool
	InFieldOfView(ent: int): bool
		very important thing for gameplay
	...
	GetGroundedOriginEx(): float[3]
		equivalent, but using world to find ground position
...
-- Deathmatch Classic
	DMC_Q_SMALL_PUNCHANGLE_KICK = -2
	DMC_Q_BIG_PUNCHANGLE_KICK = -4

	DMC_IT_AXE = 1 << 0
	DMC_IT_SHOTGUN = 1 << 1
	DMC_IT_SUPER_SHOTGUN = 1 << 2
	DMC_IT_NAILGUN = 1 << 3
	DMC_IT_SUPER_NAILGUN = 1 << 4
	DMC_IT_GRENADE_LAUNCHER = 1 << 5
	DMC_IT_ROCKET_LAUNCHER = 1 << 6
	DMC_IT_LIGHTNING = 1 << 7
	DMC_IT_EXTRA_WEAPON = 1 << 8
	...
	DMC_IT_ARMOR2 = 1 << 14
	DMC_IT_ARMOR3 = 1 << 15
	DMC_IT_SUPERHEALTH = 1 << 16

	DMC_IT_KEY1 = 1 << 17
	DMC_IT_KEY2 = 1 << 18

	DMC_IT_INVISIBILITY = 1 << 19
	DMC_IT_INVULNERABILITY = 1 << 20
	DMC_IT_SUIT = 1 << 21
	DMC_IT_QUAD = 1 << 22
